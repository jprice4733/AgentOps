...
A small reusable Python project for transcribing audio (WAV) files, creating and loading WAV transcript JSON files, indexing transcript segments, and serving a FastAPI chat agent over them.
